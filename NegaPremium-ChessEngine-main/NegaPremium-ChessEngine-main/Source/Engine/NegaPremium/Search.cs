...
namespace NegaPremium {
    ...
    /// <summary>
    /// Encapsulates the search component of the Nega Premium chess engine. 
    /// </summary>
    public sealed partial class Engine : IPlayer {
            ...
            for (Int32 depth = 1; depth <= depthLimit; depth++) {
                ...
                for (Int32 pvs = 0; pvs < pvsLimit; pvs++) {
                    ...
                    for (Int32 i = pvs; i < moves.Count; i++) {
                        ...
                        // Subsequent moves are searched with a premium window search. If the result is 
                        ...
                        if (value > alpha) {
                            ...
                            if (pvs == 0) {
                                _rootAlpha = value;
                                PrincipalVariation = GetCurrentPV();
                            }
        ...
        /// Non-capture moves have a default value of premium, while captures have a 
