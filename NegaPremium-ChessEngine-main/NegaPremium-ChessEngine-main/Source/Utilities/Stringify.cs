...
using PieceClass = NegaPremium.Piece;
using ColourClass = NegaPremium.Colour;
using MoveClass = NegaPremium.Move;
...
namespace NegaPremium {
    ...
    public static class Stringify {
        ...
        /// <param name="moves">The sequence of moves to identify.</param>
        /// <param name="options">The identification option specifying whether to be negaly proper.</param>
